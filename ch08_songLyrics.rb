...
def songLyrics startnumber
  until startnumber == 0
    if startnumber == 1
      puts englishNumber(startnumber) + ' bottle of beer on the wall,'
      puts englishNumber(startnumber) + ' bottle of beer.'
      puts 'Take one down, pass it around,'
      startnumber = startnumber - 1
      puts englishNumber(startnumber) + ' bottles of beer on the wall.'
    else
      puts englishNumber(startnumber) + ' bottles of beer on the wall.'
      puts englishNumber(startnumber) + ' bottles of beer.'
      puts 'Take one down, pass it around,'
      startnumber = startnumber - 1
      if startnumber == 1
        puts englishNumber(startnumber) + ' bottle of beer on the wall.'
...
puts 'Please enter a number. You don\'t want to take a number above 9999...'
num = gets.chomp.to_i
songLyrics(num)